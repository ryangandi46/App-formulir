...
if ($_POST) {
    ...
    $stmt = $pdo->prepare("INSERT INTO forms (title, description, allow_attachments) VALUES (?,?,?)");
    $stmt->execute([$title, $desc, $allow]);
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                Opsi (untuk radio/checkbox/select — pisahkan baris baru)
                            </label>
...
<div class="form-wrapper">
    <div class="card gform-card shadow-sm mb-3">
        <div class="gform-header">
            ...
            <p>Atur judul, deskripsi, pertanyaan, dan apakah form ini mengizinkan upload dokumen/foto.</p>
        </div>
        <div class="card-body">
            <form method="POST">
                <div class="mb-3">

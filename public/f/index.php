...
<div class="form-wrapper">
    ...
    <div class="card gform-card shadow-sm mb-3">
        ...
        <div class="card-body">
            <p class="mb-0 text-muted">
                Isi form berikut sesuai instruksi. Tanda * menandakan pertanyaan penting (kalau nanti mau ditambah).
            </p>
        </div>
    </div>

    <!-- Form utama -->
    <!-- NOTE: action ke ../submit.php karena file ini ada di /public/f/ -->
    <form action="../public/submit.php" method="POST" enctype="multipart/form-data" class="mb-4">
        ...
        <!-- Tambahan: upload file ala Google Form -->
        <div class="card question-card shadow-sm mb-3">
            <div class="card-body">
                <label class="question-label d-block mb-2">
